...
const DocumentServices = () => {
  ...
  const handleItemClick = (itemName) => {
    if (itemName === 'Income Certificate') {
      router.push('/incomeform');
    }
    if (itemName === 'Domicile Certificate') {
      router.push('/domicileform');
    }
    if (itemName === 'Non-Creamy Layer Certificate') {
      router.push('/noncreamyform');
    }
    if (itemName === 'Caste Certificate') {
      router.push('/casteform');
    }
    if (itemName === 'PAN Card') {
      router.push('/pancardform');
    }
    if (itemName === 'Passport') {
      router.push('/passportform');
    }
    if (itemName === 'Gazette') {
      router.push('/gazetteform');
    }
