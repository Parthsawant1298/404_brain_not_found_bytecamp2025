"use client";
import { ArrowRight, Shield, UserCog, FileText, Settings } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="lg:max-w-xl">
              ...
              <p className="text-base md:text-lg lg:text-xl mb-12 text-gray-600 max-w-lg">
                Manage your organization efficiently with comprehensive administrative tools. 
                Monitor user activity, manage permissions, and maintain system security 
                all from one centralized dashboard.
              </p>

              <div className="space-y-8 mb-12">
                <div className="flex items-start gap-4 max-w-md">
                  <Shield className="w-6 h-6 md:w-8 md:h-8 text-indigo-600 mt-1 flex-shrink-0" />
                  <p className="text-sm md:text-base text-gray-600">
                    Advanced security controls and user permission management
                  </p>
                </div>
                <div className="flex items-start gap-4 max-w-md">
                  <UserCog className="w-6 h-6 md:w-8 md:h-8 text-indigo-600 mt-1 flex-shrink-0" />
                  <p className="text-sm md:text-base text-gray-600">
                    User management and activity monitoring tools
                  </p>
                </div>
                <div className="flex items-start gap-4 max-w-md">
                  <Settings className="w-6 h-6 md:w-8 md:h-8 text-indigo-600 mt-1 flex-shrink-0" />
                  <p className="text-sm md:text-base text-gray-600">
