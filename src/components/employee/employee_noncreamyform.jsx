...
const NonCreamyDashboard = () => {
  ...
  const fetchApplications = async () => {
    try {
      const response = await fetch('/api/employee_noncreamy-certificate-fetch');
  ...
  const handleDownload = async (documentData, type, title) => {
    try {
      const response = await fetch('/api/employee_noncreamy-certificate-fetch/download', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-gray-900">Non-Creamy Layer Certificate Applications</h1>
            </div>
            <div className="flex items-center">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center gap-2 text-gray-600">
                      <User size={18} />
                      <span className="truncate">Caste: {app.caste}</span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-600">
                      <Calendar size={18} />
                  ...
                  <div className="mt-8">
                    ...
                    <div className="space-y-6">
                      {['photo', 'identityProof', 'addressProof', 'casteProof', 'incomeProof'].map((docType) => (
