...
const PANDashboard = () => {
  ...
  const fetchApplications = async () => {
    try {
      const response = await fetch('/api/employee_panform-certificate-fetch');
  ...
  const handleDownload = async (documentData, type, title) => {
    try {
      const response = await fetch('/api/employee_panform-certificate-fetch/download', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-gray-900">PAN Card Applications</h1>
            </div>
            <div className="flex items-center">
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-8">
                    ...
                    <div className="space-y-6">
                      {['photo', 'identityProof', 'dobProof', 'addressProof'].map((docType) => (
