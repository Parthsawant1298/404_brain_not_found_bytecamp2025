...
export default function LawyerConsultation() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const paymentResponse = await fetch("/api/create-payment-session-lawyer", {
        method: "POST",
        headers: {
      ...
      if (paymentData.success === true) {
        const res = await axios.post('/api/book-consultation-lawyer', submissionData, {
          headers: {
            'Content-Type': 'application/json',
          }
        });
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-center mb-8">Book a Lawyer Consultation</h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    {["Corporate", "Family", "Real Estate", "Criminal", "Employment", "Other"].map((type) => (
          ...
          <div className="lg:w-1/3 space-y-8">
            <div className="bg-white shadow-sm border border-gray-200 rounded-lg p-6">
              ...
              <div className="space-y-2">
                ...
                <p>
                  <strong>Address:</strong> 123 Legal St, City, State 12345
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    We offer a wide range of legal services including corporate law, family law, real estate, criminal defense, and employment law.
                  </p>
                </div>
                <div>
