          ...
          <div className="bg-white p-8 rounded-3xl shadow-xl space-y-8">
            <motion.div className="text-center space-y-2">
              ...
              <p className="text-gray-600">
                Join our professional CA network
              </p>
            </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                <span>{loading ? 'Creating Account...' : 'Register as CA'}</span>
            ...
            <div className="text-center space-y-4">
              <p className="text-gray-600">
                Already registered?{' '}
                <Link href="/caloginpage" className="text-indigo-600 hover:text-indigo-500 font-medium transition-colors">
                  Sign in
                </Link>
              </p>
