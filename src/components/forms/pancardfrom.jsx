...
// Reusing the existing components (CustomAlert, UploadIcon, FileUploadField)
...
const PANCardForm = () => {
  const initialFormState = {
    ...
    dobProofType: 'birth_certificate',
  ...
  // Handlers remain similar to the original form
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/submit-pan-application', {
        method: 'POST',
        headers: {
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Identity Proof Type</label>
                  <select
                  ...
                  >
                    ...
                    <option value="gazetted">Gazetted Officer Certificate</option>
                  </select>
                  ...
                  <div className="mt-4">
                    <FileUploadField
                      ...
                      isFileSelected={!!formData.files.identityProof}
                      preview={preview.identityProof}
                      handleFileChange={(e) => handleFileChange(e, 'identityProof')}
                      handleRemoveFile={() => handleRemoveFile('identityProof')}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="affidavit">Affidavit of Birth</option>
                  </select>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="gas_bill">Gas Connection Bill</option>
                  </select>
