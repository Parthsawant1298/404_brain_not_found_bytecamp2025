...
const GazetteDashboard = () => {
  ...
  const fetchApplications = async () => {
    try {
      const response = await fetch('/api/gazette-fetch');
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Name Change Applications</h1>
            ...
            <CardHeader className="bg-gray-50">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-600 mt-1 text-sm">Application ID: {app._id}</p>
                </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                    <p className="text-gray-600 font-medium mb-1">Reason for Change:</p>
                ...
                <div className="mt-8">
                  ...
                  <div className="space-y-6">
                    <DocumentPreview 
                      ...
                      type={app.affidavit.contentType}
                    ...
                    />
                    <DocumentPreview 
                      data={app.newspaperAds.data} 
                      type={app.newspaperAds.contentType}
                      title="Newspaper Advertisements"
                    />
                    <DocumentPreview 
                      data={app.applicationForm.data} 
                      type={app.applicationForm.contentType}
                      title="Application Form"
                    />
                    <DocumentPreview 
                      data={app.paymentProof.data} 
                      type={app.paymentProof.contentType}
                      title="Payment Proof"
                    />
                    <DocumentPreview 
                      data={app.coverLetter.data} 
                      type={app.coverLetter.contentType}
                      title="Cover Letter"
                    />
                    <DocumentPreview 
                      data={app.photos.data} 
                      type={app.photos.contentType}
                      title="Passport Size Photos"
                    />
                    <DocumentPreview 
                      data={app.digitalCD.data} 
                      type={app.digitalCD.contentType}
                      title="Digital CD Content"
                    />
                  </div>
                </div>
              </div>
