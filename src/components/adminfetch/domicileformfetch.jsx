...
import { Search, Filter, Calendar, Download, Mail, Phone, MapPin, Clock, FileText } from 'lucide-react';
...
const DomicileDashboard = () => {
  ...
  const fetchApplications = async () => {
    try {
      const response = await fetch('/api/domicile-fetch');
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Domicile Certificate Applications</h1>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-2 text-gray-600">
                    <Clock size={18} />
                    <span>Stay: {app.stayDuration} years</span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-600">
                    <Mail size={18} />
                    <span>{app.email}</span>
                ...
                <div className="mt-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <DocumentPreview 
                      ...
                      title={`ID Proof (${app.idProofType})`}
                    />
                    <DocumentPreview 
                    ...
                    <DocumentPreview 
                      ...
                      type={app.schoolCertificate.contentType}
