...
import { Search, Filter, Calendar, Download, Mail, Phone, MapPin, FileText, User } from 'lucide-react';
...
const PANDashboard = () => {
  ...
  const fetchApplications = async () => {
    try {
      const response = await fetch('/api/pan-fetch');
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900">PAN Card Applications</h1>
                ...
                <div className="mt-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <DocumentPreview 
                      ...
                      proofType={app.identityProofType}
                    />
                    <DocumentPreview 
