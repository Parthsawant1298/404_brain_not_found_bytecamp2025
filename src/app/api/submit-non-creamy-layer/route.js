...
const validateField = (value, field, validationRules = {}) => {
  ...
  if (field === 'caste' && value.trim().length < 2) {
...
export async function POST(req) {
  try {
    ...
    // Validate files
    const requiredFiles = ['photo', 'identityProof', 'addressProof', 'casteProof', 'incomeProof'];
    ...
    const application = new NonCreamyApplication({
